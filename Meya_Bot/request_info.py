...
class Information:
    ...
    def check_infos(self):
        if self._request_title != "" and self._category != "" and self._place != "" and self._comment != "":
            db.insert_request_info(self._request_title, self._category, self._place, self._comment)
    ...
    def write_Category(self):
        ...
        print("Quelle est la catgegorie de votre Problème (Tapez \"autre\" si categorie non proposée)  :")
        talk("Quelle est la catgegorie de votre Problème (Tapez \"autre\" si categorie non proposée)  :")
    ...
    def Recap_Information(self):
        ...
        print("Categorie: {}".format(self.get_category()))
        talk("Categorie: {}".format(self.get_category()))
